...
namespace NCalcExcel
{
    public class Numbers
    {
        public static object ConvertIfString(object s)
        {
            ...
            {
                if (string.IsNullOrEmpty(s.ToString()) || string.IsNullOrWhiteSpace(s.ToString()) || s.Equals("\"\"")) {
                    return 0.0;
                }
            ...
            switch (typeCodeA) {
                ...
                case TypeCode.Double:
                    switch (typeCodeB) {
                        ...
                        case TypeCode.Decimal: return Decimal.Parse(a.ToString()) + (Decimal)b;//PRECISION
                    }
                    break;
                ...
                case TypeCode.Decimal:
                    switch (typeCodeB) {
                        ...
                        case TypeCode.Double: return Double.Parse(a.ToString()) + (Double)b;//  PRECISION LOSS
            ...
            switch (typeCodeA) {
                ...
                case TypeCode.Double:
                    switch (typeCodeB) {
                        ...
                        case TypeCode.Single: return (Double)a - (Single)b;
                        case TypeCode.Double: return (Double)a - (Double)b;
                        case TypeCode.Decimal:return Decimal.Parse( a.ToString()) - (Decimal)b; //  PRECISION LOSS 
                ...
                case TypeCode.Decimal:
                    switch (typeCodeB) {
                        ...
                        case TypeCode.UInt64: return (Decimal)a - (UInt64)b;
                        case TypeCode.Single: throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'decimal' and 'float'");
                        case TypeCode.Double: return (Decimal)a - Decimal.Parse(b.ToString()); //  PRECISIN LOSS
                        case TypeCode.Decimal: return (Decimal)a - (Decimal)b;
                    }
                    break;
            }
            ...
            switch (typeCodeA) {
                ...
                case TypeCode.Double:
                    switch (typeCodeB) {
                        ...
                        case TypeCode.Double: return (Double)a * (Double)b;
                        case TypeCode.Decimal:
                            return Decimal.Parse(a.ToString())*(Decimal) b; //  PRECISION LOSS
                    }
                    break;
                ...
                case TypeCode.Decimal:
                    switch (typeCodeB) {
                        ...
                        case TypeCode.Double: return (Decimal)a * Convert.ToDecimal(b); // precision
                        case TypeCode.Decimal: return (Decimal)a * (Decimal)b;
                    }
                    break;
            }
            ...
            switch (typeCodeA) {
                ...
                case TypeCode.Double:
                    switch (typeCodeB) {
                        ...
                        case TypeCode.Single: return (Double)a / (Single)b;
                        case TypeCode.Double: return (Double)a / (Double)b;
                        case TypeCode.Decimal: return Convert.ToDecimal(a) / (Decimal)b; // DAVID throw new InvalidOperationException("Operator '/' can't be applied to operands of types 'double' and 'decimal'");
                    }
                    break;
