        ...
        public override void Visit(ValueExpression expression)
        {
            switch (expression.Type)
            {
                ...
                case ValueType.Float:
                    ...
                    } else if (expression.Value is double || expression.Value is float || expression.Value is int) {
                        value = (decimal) (double) expression.Value;
                    } else {
                        throw new ArgumentOutOfRangeException("not a number");
                    }
                    result.Append(value.ToString(numberFormatInfo)).Append(" ");
                    break;
