...
namespace NCalcExcel
{
    public class Expression
    {
        ...
        public object Evaluate()
        {
            ...
            EvaluationVisitor visitor = new EvaluationVisitor(Options,FunctionsMap);
        ...
        /// <summary>
        /// This holds the list of ALL functions known
        /// </summary>
        private static ConcurrentDictionary<string, AFunction> _functionsMap;

        public static ConcurrentDictionary<string, AFunction> FunctionsMap {
            get {
                if (Expression._functionsMap == null) { // if we don't know of any then we should find some
                    Expression._functionsMap = (new ExpressionFactory()).FunctionDictionary;                    
                }
                return Expression._functionsMap;
            }
            set { Expression._functionsMap = value; }
        }
